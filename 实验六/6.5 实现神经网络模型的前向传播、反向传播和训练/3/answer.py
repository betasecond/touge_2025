...
def train_one_iter(W_conv1, b_conv1, W_conv2, b_conv2, W_fc, b_fc, x, t, learning_rate):
    ...
    ########## Begin ##########
    new_W_conv1 = W_conv1 - learning_rate * dW_conv1
    new_b_conv1 = b_conv1 - learning_rate * db_conv1
    new_W_conv2 = W_conv2 - learning_rate * dW_conv2
    new_b_conv2 = b_conv2 - learning_rate * db_conv2
    new_W_fc = W_fc - learning_rate * dW_fc
    new_b_fc = b_fc - learning_rate * db_fc
    ########## End ##########
